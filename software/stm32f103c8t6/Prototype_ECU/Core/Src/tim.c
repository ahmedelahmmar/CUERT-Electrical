...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM4_MspPostInit 0 */
    ...
    PB6     ------> TIM4_CH1
    */
    GPIO_InitStruct.Pin = PWM_CURRENT_SPEED_PERCENT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    HAL_GPIO_Init(PWM_CURRENT_SPEED_PERCENT_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA11     ------> TIM1_CH4
    */
    HAL_GPIO_DeInit(GPIOA, PWM_PHASE_U_Pin|PWM_PHASE_V_Pin|PWM_PHASE_W_Pin|ICU_HALL_SENSOR_X_Pin);
